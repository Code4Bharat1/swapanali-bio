          ...
          {[0, 2, 4].map((start, rowIndex) => (
            ...
            >
              {testimonials.slice(start, start + 2).map((t, index) => {
                // ✅ First card from right, second from left
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* Blue Circle Avatar with First Letter */}
                      <motion.div 
                        className="absolute -top-10 left-1/2 transform -translate-x-1/2"
                        whileHover={{ scale: 1.1 }}
                      >
                        <div className="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center border-4 border-white shadow-lg hover:bg-blue-600 transition-colors duration-300">
