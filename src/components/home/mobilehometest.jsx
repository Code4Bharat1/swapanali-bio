...
export default function TestMobile() {
  return (
    <section className="block md:hidden bg-gradient-to-r from-blue-300 to-blue-300 py-12 px-4 w-full overflow-hidden">
      ...
      {/* Testimonials Container - Centered */}
...
>
  ...
  >
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="w-16 h-16 rounded-full overflow-hidden bg-white border-4 border-white shadow-md flex items-center justify-center">
        <Image
          src={t.image}
